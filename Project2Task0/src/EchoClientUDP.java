 ...
 * This class represents a simple UDP client that interacts with an echo server. * The client sends messages to the server, which then echoes the same messages back. * The client listens for responses and displays them. The program exits when "halt!" is entered. */
